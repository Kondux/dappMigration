// Founders Pass Contract
export const contractAddress = "0x0fD5576c2842bD62dd00C5256491D11CcAD84306";
...
export const contractABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_kondux", type: "address" },
  ...
  },
  {
    inputs: [],
    name: "kondux",
    outputs: [{ internalType: "contract IKondux", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_rootFounders020", type: "bytes32" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_rootFounders025", type: "bytes32" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_rootFreeFounders", type: "bytes32" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_rootFreeKNFT", type: "bytes32" },
    ],
