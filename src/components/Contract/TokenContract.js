// Token Contract
export const contractAddress4 = "0x2fa9e338CFe579Ff4575BeD2e1Ea407e811F35bc";

export const contractABI4 = [
  ...
  {
    inputs: [
      { internalType: "uint8", name: "newBuyTax", type: "uint8" },
      { internalType: "uint8", name: "newSellTax", type: "uint8" },
    ],
    name: "adjustTaxRate",
    outputs: [],
  ...
  {
    inputs: [
      { internalType: "address", name: "newTaxWallet", type: "address" },
    ],
    name: "setTaxWallet",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint32", name: "minDivider", type: "uint32" },
      { internalType: "uint32", name: "maxValue", type: "uint32" },
      { internalType: "uint32", name: "maxDivider", type: "uint32" },
    ],
