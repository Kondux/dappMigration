...
function NftOwned({
  ...
  const [clickedNFTData, setClickedNFTData] = useState();
          ...
          <div style={{ padding: "20px", width: "100%" }}>
            <div style={styles.NFTs}>
              <Box>
                ...
                >
                  You have no NFTs. Please go to the Grey Marketplace and
                  acquire some awesome NFTs! 👽
                </p>
              </Box>
            </div>
          </div>
                ...
                {filterActive === false ? (
                  <>
                    ...
                    <Skeleton loading={!TestNFTs}>
                      {TestNFTs.Background === undefined ? (
                        <></>
                      ) : (
                        <>
                          {TestNFTs.Background.length > 0 &&
                            TestNFTs.Background[0]?.name !== "None" &&
                            TestNFTs.Background.map((nft, index) => {
                              //Verify Metadata
                    ...
                    {/* Avatar */}
                    <Skeleton loading={!TestNFTs}>
                      {TestNFTs.Avatar === undefined ? (
                        <></>
                      ) : (
                        <>
                          {TestNFTs.Avatar[0]?.name !== "None" &&
                            TestNFTs.Avatar.map((nft, index) => {
                              //Verify Metadata
                              // nft = verifyMetadata(nft);
                              return (
                                <Flex
                    ...
                    {/* Skin */}
                    <Skeleton loading={!TestNFTs}>
                      {TestNFTs.Skin === undefined ? (
                        <></>
                      ) : (
                        <>
                          {TestNFTs.Skin[0]?.name !== "None" &&
                            TestNFTs.Skin.map((nft, index) => {
                              //Verify Metadata
                              // nft = verifyMetadata(nft);
