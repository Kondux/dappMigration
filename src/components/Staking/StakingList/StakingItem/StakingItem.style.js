...
import headingShape from "../../images/bg/shape-bg.png";
import cardBackShape from "../../images/bg/staking_flip_card_blur_img.png";
import headingBgShape from "../../images/bg/staking_header_shape.png";
...
const StakingItemStyleWrapper = styled.div`
  ...
  .staking_flip_card_front_list_approve {
    // margin-top: 41px !important;
    margin-bottom: 20px !important;
  ...
  .staking_flip_card_back_body_inner {
    width: 100%;
    position: relative;
    z-index: 1;
    // display: flex;
  ...
  .staking_flip_card_back_approve_btn_mobile {
    position: relative;
    width: 100%;
    margin-top: 25px;
