...
export default function GreyV1({
  eyecolor,
  color,
  armor,
  play,
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF("/GreyV1-transformed.glb");
  ...
  // const newNormal = useTexture({
  //     bumpMap: "/images/repNormal.jpg",
  // });

  // console.log(materials.__meshes_Merge);
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group>
        <group name="GreyV1_Cloth_AETS_BW_BaseColorMap001" scale={1.6}>
        ...
        <group name="GreyV1_Cloth_AETS_BW_BaseColorMap" scale={1.6}>
...
// useGLTF.preload("/GreyV1-transformed.glb");
