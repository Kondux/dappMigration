...
export default function Lo_Frame({
  avatarType,
  eyecolor,
  color,
  armor,
  ...
  const [skinVariantDir, setSkinVariantDir] = useState(
    "/Assets/LoAvatarMaterial.glb"
  );
  ...
  //This is from frame
  const { nodes } = useGLTF("/Assets/LoFrame.glb");

  //This is from materials only
...
// useGLTF.preload("/Assets/LoFrame.glb");
