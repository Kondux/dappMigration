...
export default function Amber({ ...props }) {
    const group = useRef();
    const { nodes, materials } = useGLTF("/Amber.glb");
            ...
            <group>
                <group name="Spin001" scale={1}>
                    ...
                    <skinnedMesh
                        frustumCulled={false}
                        name="High_Heels_1"
                        geometry={nodes.High_Heels_1.geometry}
                        material={materials.High_Heels}
                        skeleton={nodes.High_Heels_1.skeleton}
                    />
                    <skinnedMesh
                        frustumCulled={false}
                    ...
                    <skinnedMesh
                        frustumCulled={false}
                        name="Rolled_sleeves_shirt_1"
                        geometry={nodes.Rolled_sleeves_shirt_1.geometry}
                        material={materials.Rolled_sleeves_shirt}
                        skeleton={nodes.Rolled_sleeves_shirt_1.skeleton}
                    />
                    <skinnedMesh
                        frustumCulled={false}
                        name="CC_Base_Tongue"
