...
import Kube from "./VPComponents/MintBox";
...
// Basically will need to import all variants here //

// First upload frame for avatar Rept V1 Frame
// import JoroFrame from "./VPComponents/JoroFrame";

// First upload frame for avatar Grey V1 Frame
import Lo_Frame from "./VPComponents/Lo_Frame";

//Rept Var 1
// import JoroAvatarOnly from "./VPComponents/JoroAvatarOnly";

//Rept Var 1 Armor 1
// import JoroArmor1Frame from "./VPComponents/JoroArmor1Frame";

// First upload frame for avatar Grey V1 Frame
import LoArmor1Frame from "./VPComponents/LoArmor1Frame";

// import GreyArmor1 from "./VPComponents/GreyArmor1";
// //Grey Var 1 Armor 2
// import GreyArmor2 from "./VPComponents/GreyArmor2";

//Grey Var 1 Armor 1
// import JoroAxe from "./VPComponents/JoroAxe";
...
export default function ViewPort() {
  ...
  const [isFullScreenHeight, setFullScreenHeight] = useState("100vh");
  const [isFullScreenWidth, setFullScreenWidth] = useState("100vw");
  const [isFullScreenPosition, setFullScreenPosition] = useState("fixed");
  const [isFullScreenTop, setFullScreenTop] = useState("IsFullScreenTop");
                  ...
                  {isMobile === true ? (
                    ...
                    <>
                      <Suspense>
                        ...
                        {/* NEED TO MAKE STRUCTURE FOR ACTUAL MODULATION OF ASSETS */}

                        {/* NEED BASE AVATAR TEMPLATE */}

                        {/* NEED ALL ASSETS ACTIVATED */}

                        {/* NEED ALL MAPS VARIATIONS */}

                        {/* ALL GLBS NEED TO BE LOADED HERE (NOT PRELOADED) */}

                        {/* HOW TO PULL TEMPLATE GLBS BY VARIABLE? */}

                        <>
                          <group>
                            {/* BASE GLB */}
                            {/* NEED TO ADD ALL VARIANTIONS TO BASE MODELS */}
                            {overlaymenu.avatarType === "Reptilian" ? (
                              <>
                                {/* <JoroFrame
                                  castShadow
                                  receiveShadow
                                  avatarType={overlaymenu.avatarType}
                                  color={overlaymenu.armorcolor}
                                  eyecolor={overlaymenu.eyecolor}
                                  // skin={overlaymenu.skincolor}
                                  skin={overlaymenu.skinVariant}
                                  head={headLink}
                                  weapon={weaponLink}
                                  armor={overlaymenu.armorType}
                                  animationClip={overlaymenu.animationClip}
                                  isPlaying={spacePress}
                                  scale={1}
                                  position={[0, 0, 0]}
                                  rotation={[0, 0, 0]}
                                /> */}
